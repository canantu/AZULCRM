Feature: As a user, I should be able to create events by clicking on Event tab under Activity Stream
  ...
  Scenario: Verify that user can add Event date and time with the time zone
    ...
    And user selects event start date
    And user selects event start time
    And user selects event end data
    And user selects event end time
  ...
  Scenario: Verify that time zone is displayed correctly in event page
    ...
    |Europe/London|
    And user clicks Send button
    Then user sees event start time is displayed correctly in Activity Stream
  ...
  Scenario: Verify that user can select the event location
    When user enters event name
